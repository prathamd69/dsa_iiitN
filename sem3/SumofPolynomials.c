...
struct node *add(struct node *head3, struct node *head1, struct node *head2)
{
    ...
    while (temp1 != NULL && temp2 != NULL)
    {
        ...
        {
            head3 = polynomial(head3, temp1->coeff, temp1->expo);
            temp1 = temp1->link;
        }
        else if (temp1->expo < temp2->expo)
        {
            head3 = polynomial(head3, temp2->coeff, temp2->expo);
            temp2 = temp2->link;
        }
        else
        {
            head3 = polynomial(head3, temp1->coeff + temp2->coeff, temp1->expo);
            temp1 = temp1->link;
            temp2 = temp2->link;
        }
    }
...
Enter the expo - 1
 ...
 Polynomial 2 -->  2.00X(2) +1.00X(1)

 Sum of both Polynomials -> 4.00X(2) +2.00X(1)
*/
...
Enter the expo - 0
 ...
 Polynomial 1 -->  3.00X(2) +2.00X(1) +1.00
...
Enter the expo - 0
 ...
 Polynomial 2 -->  5.00X(2) -1.00X(1) +2.00

 Sum of both Polynomials -> 8.00X(2) +1.00X(1) +3.00
*/
...
Enter the expo - 3
 ...
 Polynomial 1 -->  5.00X(6) +6.00X(4) +2.00X(3)

---- Polynomial 2 ----
Enter the num of terms you want to insert - 4
...
Enter the expo - 0
 ...
 Polynomial 2 -->  8.00X(6) +3.00X(2) +4.00X(1) +5.00

 Sum of both Polynomials -> 13.00X(6) +6.00X(4) +2.00X(3) +3.00X(2) +4.00X(1) +5.00
*/